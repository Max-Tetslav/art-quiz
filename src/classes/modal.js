...
class Modal {
  constructor(
    ...
    load(
      this.target.querySelector('.answer-status'),
      isRight ? './assets/svg/right-answer.svg' : './assets/svg/wrong-answer.svg',
    );
  ...
  nextQuestion() {
    ...
    return new EndRound(this.target, this.categoryType, this.categoryData, this.roundData, this.score, this.roundId);
  }
}
